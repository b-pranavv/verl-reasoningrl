...
class ActorRolloutRefWorker(Worker):
    ...
    def _build_rollout(self, trust_remote_code=False):
        ...
        if rollout_name == "hf":
        ...
        elif rollout_name == "vllm_with_python":
            from verl.workers.rollout.vllm_rollout import vllm_mode, vLLMRolloutWithPython
            from verl.workers.sharding_manager.fsdp_vllm import FSDPVLLMShardingManager
            ...
            if vllm_mode == "customized":
                ...
                from verl.workers.rollout.vllm_rollout import vLLMRolloutWithPython

                vllm_rollout_cls = vLLMRolloutWithPython
                rollout = vllm_rollout_cls(
                    model_path=local_path,
                    config=self.config.rollout,
                    tokenizer=self.tokenizer,
        ...
        elif rollout_name == "vllm_with_tool":
            from verl.workers.rollout.vllm_rollout import vllm_mode, vLLMRolloutWithTool
            from verl.workers.sharding_manager.fsdp_vllm import FSDPVLLMShardingManager
            ...
            if vllm_mode == "customized":
                ...
                from verl.workers.rollout.vllm_rollout import vLLMRolloutWithTool

                vllm_rollout_cls = vLLMRolloutWithTool
                rollout = vllm_rollout_cls(
                    model_path=local_path,
                    config=self.config.rollout,
                    tokenizer=self.tokenizer,
