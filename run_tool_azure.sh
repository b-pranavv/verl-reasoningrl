...
CMD="python -m verl.trainer.main_ppo \
    ...
    data.max_response_length=$((MAX_RESPONSE_LENGTH-4000)) \
    data.use_tool=True \
    data.prompt_key=question \
    data.prompt_template_name=re_tool_template_sys \
    ...
    actor_rollout_ref.rollout.max_num_batched_tokens=$((MAX_RESPONSE_LENGTH+4000)) \
