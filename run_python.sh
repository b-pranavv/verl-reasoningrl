...
CMD="python -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.model.path=../model/$BASE_MODEL \
    ...
    trainer.default_local_dir=verl_checkpoints/$EXPERIMENT_NAME/checkpoints \
    trainer.save_rollout_path=verl_checkpoints/$EXPERIMENT_NAME/rollouts \
